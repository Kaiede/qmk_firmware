...
#define HSV_AMBER       21, 255, 200 // Define custom "amber" color
#define HSV_WARM_WHITE  41, 105, 100 // Define custom "warm white" color

void keyboard_post_init_user(void) {
    rgb_matrix_enable_noeeprom();
    rgb_matrix_mode_noeeprom(RGB_MATRIX_SOLID_COLOR);
    rgb_matrix_sethsv_noeeprom(HSV_AMBER);
...
[_FL] = LAYOUT_65_ansi_blocker(
  ...
  _______,  RGB_HUI,  RGB_HUD,  RGB_SPD,  RGB_SPI,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,             RGB_VAI,  KC_END,
